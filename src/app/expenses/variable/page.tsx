...
export default function VariableExpensesPage() {
  ...
  const transactionsQuery = useMemo(() => {
    ...
    return query(
      ...
      where('type', '==', 'expense'),
      where('expenseType', 'in', ['single', 'installments'])
    );
  ...
  const variableExpenseTransactions = transactions || [];
      ...
      <div className="flex min-h-screen w-full flex-col bg-background">
        ...
        <main className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-semibold md:text-2xl">Despesas Variáveis</h1>
          </div>
          <div
          ...
          >
              <TransactionsTable 
                  ...
                  description="Uma lista de todas as suas despesas variáveis."
